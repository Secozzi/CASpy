...
class CalcSystemEqTester(BaseTester):
    ...
    def test_calc_system_eq_system_1(self):
        ...
        solution = {
            "eq": [
                "[x = 4, y = 1]\n\n[x = 1, y = 4]\n\n",
                [
                    ["x = 4.000000000", "y = 1.000000000"],
                    ["x = 1.000000000", "y = 4.000000000"],
                ],
            ],
            "latex": "\\left[ x = 4, \\  y = 1\\right] \\\\ \\left[ x = 1, \\  y = 4\\right]",
        }
        return command, params, solution
    ...
    def test_calc_system_eq_system_2(self):
        command = "calc_system_eq"
        params = [
            ["2*x**2+y+z_1 = 1", "x+2*y+z_1 = z_2", "-2*x+y = -z_1"],
            "x y z_1",
            "Complexes",
            1,
            1,
        ...
        solution = {
            ...
            "latex": "\\left[ x = - \\frac{1}{2} + \\frac{\\sqrt{3}}{2}, \\  y = z_{2} - \\frac{3 \\sqrt{3}}{2} + \\frac{3}{2}, \\  z_{1} = - z_{2} - \\frac{5}{2} + \\frac{5 \\sqrt{3}}{2}\\right] \\\\ \\left[ x = - \\frac{\\sqrt{3}}{2} - \\frac{1}{2}, \\  y = z_{2} + \\frac{3}{2} + \\frac{3 \\sqrt{3}}{2}, \\  z_{1} = - z_{2} - \\frac{5 \\sqrt{3}}{2} - \\frac{5}{2}\\right]",
        }
        return command, params, solution
    ...
    def test_calc_system_ode(self):
        ...
        solution = {
            "eq": [
                ...
                [
                    Eq(g(x), -1 / (C1 - cos(x))),
                    Eq(f(x), -exp(C1) / (C2 * exp(C1) - cos(x))),
                ],
            ],
            "latex": "g{\\left(x \\right)} = - \\frac{1}{C_{1} - \\cos{\\left(x \\right)}} \\\\ f{\\left(x \\right)} = - \\frac{e^{C_{1}}}{C_{2} e^{C_{1}} - \\cos{\\left(x \\right)}} \\\\ ",
        }
        return command, params, solution
    ...
    def test_calc_system_eq_normal(self):
        ...
        solution = {
            "eq": [
                "[[Eq(x, -1/2 + sqrt(3)/2), Eq(y, z_2 - 3*sqrt(3)/2 + 3/2), Eq(z_1, -z_2 - 5/2 + 5*sqrt(3)/2)], [Eq(x, -sqrt(3)/2 - 1/2), Eq(y, z_2 + 3/2 + 3*sqrt(3)/2), Eq(z_1, -z_2 - 5*sqrt(3)/2 - 5/2)]]",
                [
                    [
                        "x = 0.3660254038",
                        "y = z_2 - 1.098076211",
    ...
    def test_calc_system_eq_accuracy(self):
        ...
        solution = {
            "eq": [
                ...
                [
                    [
                        "x = 0.3660254037844386467637232",
                        "y = z_2 - 1.098076211353315940291169",
                        "z_1 = 1.830127018922193233818616 - z_2",
                    ],
                    [
                        "x = -1.366025403784438646763723",
                        "y = z_2 + 4.098076211353315940291169",
                        "z_1 = -z_2 - 6.830127018922193233818616",
                    ],
                ],
            ],
            "latex": "\\left[ x = - \\frac{1}{2} + \\frac{\\sqrt{3}}{2}, \\  y = z_{2} - \\frac{3 \\sqrt{3}}{2} + \\frac{3}{2}, \\  z_{1} = - z_{2} - \\frac{5}{2} + \\frac{5 \\sqrt{3}}{2}\\right] \\\\ \\left[ x = - \\frac{\\sqrt{3}}{2} - \\frac{1}{2}, \\  y = z_{2} + \\frac{3}{2} + \\frac{3 \\sqrt{3}}{2}, \\  z_{1} = - z_{2} - \\frac{5 \\sqrt{3}}{2} - \\frac{5}{2}\\right]",
    ...
    def test_calc_system_eq_scientific_notation(self):
        ...
        solution = {
            "eq": [
                ...
                [
                    [
                        "x = 3.660254037844386467637232*10**(-1)",
                        "y = z_2 - 1.098076211353315940291169",
                        "z_1 = 1.830127018922193233818616 - z_2",
                    ],
                    [
                        "x = -1.366025403784438646763723*10**0",
                        "y = z_2 + 4.098076211353315940291169",
                        "z_1 = -z_2 - 6.830127018922193233818616",
                    ],
                ],
    ...
    def test_calc_system_eq_verify_domain(self):
        ...
        solution = {
            "eq": [
                "                    /         1    \\ \n                    |     ---------| \n                    |     3*log(10)| \n     202500         |/119\\         | \n[a = ------, b = log||---|         |]\n      119           \\\\450/         / \n\n",
                [
                    "a = 1.701680672268907563025210*10**3",
                    "b = -1.925551841276043067079769*10**(-1)",
                ],
            ],
            "latex": "\\left[ a = \\frac{202500}{119}, \\  b = \\log{\\left(\\left(\\frac{119}{450}\\right)^{\\frac{1}{3 \\log{\\left(10 \\right)}}} \\right)}\\right]",
        }
        return command, params, solution
