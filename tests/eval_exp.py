...
class EvalExpTester(BaseTester):
    ...
    def test_eval_exp_var_sub(self):
        ...
        solution = {
            "eval": ["  /         2\\\nE*\\-2*pi + e /", "3.006068478"],
            "latex": "e \\left(- 2 \\pi + e^{2}\\right)",
        }
        return command, params, solution
    ...
    def test_eval_exp_latex(self):
        ...
        solution = {
            "eval": ["e \\left(- 2 \\pi + e^{2}\\right)", "3.006068478"],
            "latex": "e \\left(- 2 \\pi + e^{2}\\right)",
        }
        return command, params, solution
    ...
    def test_eval_exp_accuracy(self):
        ...
        solution = {
            "eval": ["  /         2\\\nE*\\-2*pi + e /", "3.006068477840533610001428"],
            "latex": "e \\left(- 2 \\pi + e^{2}\\right)",
        }
        return command, params, solution
    ...
    def test_eval_exp_scientific_notation(self):
        ...
        solution = {
            "eval": [
                "  /         2\\\nE*\\-2*pi + e /",
                "3.006068477840533610001428*10**0",
            ],
            "latex": "e \\left(- 2 \\pi + e^{2}\\right)",
        }
        return command, params, solution
