...
class CalcFormulaTester(BaseTester):
    ...
    def test_calc_formula(self):
        ...
        solution = {
            "eq": ["[6/25]", "0.2400000000"],
            "latex": "\\left[ \\frac{6}{25}\\right]",
        }
        return command, params, solution
    ...
    def test_calc_formula_latex(self):
        ...
        solution = {
            "eq": ["\\left[ \\frac{6}{25}\\right]", "0.2400000000"],
            "latex": "\\left[ \\frac{6}{25}\\right]",
        }
        return command, params, solution
    ...
    def test_calc_formula_var(self):
        ...
        solution = {
            "eq": [["2*Ek/v**2"], "2.0*Ek/v**2"],
            "latex": "\\left[ \\frac{2 Ek}{v^{2}}\\right]",
        }
        return command, params, solution
    ...
    def test_calc_formula_unicode(self):
        ...
        solution = {
            "eq": ["[-√5⋅ⅈ, √5⋅ⅈ]", ["-2.236067978*I", "2.236067978*I"]],
            "latex": "\\left[ - \\sqrt{5} i, \\  \\sqrt{5} i\\right]",
        }
        return command, params, solution
    ...
    def test_calc_formula_accuracy(self):
        ...
        solution = {
            "eq": [" 12 \n[--]\n 49 ", "0.2448979591836734693877551"],
            "latex": "\\left[ \\frac{12}{49}\\right]",
        }
        return command, params, solution
    ...
    def test_calc_formula_scientific_notation(self):
        ...
        solution = {
            "eq": [" 12 \n[--]\n 49 ", "2.448979591836734693877551*10**(-1)"],
            "latex": "\\left[ \\frac{12}{49}\\right]",
        }
        return command, params, solution
    ...
    def test_calc_formula_verify_domain(self):
        ...
        solution = {
            "eq": ["    ___ \n[-\\/ 3 ]", "-1.732050807568877293527446*10**0"],
            "latex": "\\left[ - \\sqrt{3}\\right]",
        }
        return command, params, solution
