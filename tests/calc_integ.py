...
from caspy3.qt_assets.tabs.integral import IntegralWorker
...
class CalcIntegTester(BaseTester):
    ...
    @BaseTester.call_worker(IntegralWorker)
    ...
    def test_calc_integ(self):
        ...
        solution = {
            "integ": [
                "    ___    / 2     ___      \\     ___    / 2     ___      \\     ___     /  ___      \\     ___     /  ___      \\\n  \\/ 2 *log\\x  - \\/ 2 *x + 1/   \\/ 2 *log\\x  + \\/ 2 *x + 1/   \\/ 2 *atan\\\\/ 2 *x - 1/   \\/ 2 *atan\\\\/ 2 *x + 1/\n- --------------------------- + --------------------------- + ----------------------- + -----------------------\n               8                             8                           4                         4           ",
                0,
            ],
            "latex": "- \\frac{\\sqrt{2} \\log{\\left(x^{2} - \\sqrt{2} x + 1 \\right)}}{8} + \\frac{\\sqrt{2} \\log{\\left(x^{2} + \\sqrt{2} x + 1 \\right)}}{8} + \\frac{\\sqrt{2} \\operatorname{atan}{\\left(\\sqrt{2} x - 1 \\right)}}{4} + \\frac{\\sqrt{2} \\operatorname{atan}{\\left(\\sqrt{2} x + 1 \\right)}}{4}",
        }
        return command, params, solution
    ...
    def test_calc_integ_var(self):
        ...
        solution = {
            ...
            "latex": "- \\frac{\\sqrt{2} \\log{\\left(hi^{2} - \\sqrt{2} hi + 1 \\right)}}{8} + \\frac{\\sqrt{2} \\log{\\left(hi^{2} + \\sqrt{2} hi + 1 \\right)}}{8} + \\frac{\\sqrt{2} \\operatorname{atan}{\\left(\\sqrt{2} hi - 1 \\right)}}{4} + \\frac{\\sqrt{2} \\operatorname{atan}{\\left(\\sqrt{2} hi + 1 \\right)}}{4}",
        }
        return command, params, solution
    ...
    def test_calc_integ_scientific_notation(self):
        ...
        solution = {
            "integ": ["pi\n--\n2 ", "1.570796326794896619231322*10**0"],
            "latex": "\\frac{\\pi}{2}",
        }
        return command, params, solution
    ...
    def test_calc_integ_approximate_integral(self):
        ...
        solution = {
            "integ": [
                "0.04442317879 - 0.8573631716*I",
                "0.04442317879 - 0.8573631716*I",
            ],
            "latex": "0.04442317879 - 0.8573631716 i",
        }
        return command, params, solution
