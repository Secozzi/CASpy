...
from caspy3.qt_assets.tabs.expand import ExpandWorker
...
class ExpandExpTester(BaseTester):
    ...
    def test_expand_exp(self):
        ...
        solution = {
            "exp": [
                " 3      2        2          2                  2    3      2          2    3\na  + 3*a *b - 3*a *c + 3*a*b  - 6*a*b*c + 3*a*c  + b  - 3*b *c + 3*b*c  - c ",
                0,
            ],
            "latex": "a^{3} + 3 a^{2} b - 3 a^{2} c + 3 a b^{2} - 6 a b c + 3 a c^{2} + b^{3} - 3 b^{2} c + 3 b c^{2} - c^{3}",
        }
        return command, params, solution
    ...
    def test_expand_exp_unicode(self):
        ...
        solution = {
            "exp": [
                " 3      2          2        2                2      3        2      2      3\na  + 3⋅a ⋅b - 3⋅π⋅a  + 3⋅a⋅b  - 6⋅π⋅a⋅b + 3⋅π ⋅a + b  - 3⋅π⋅b  + 3⋅π ⋅b - π ",
                0,
            ],
            "latex": "a^{3} + 3 a^{2} b - 3 \\pi a^{2} + 3 a b^{2} - 6 \\pi a b + 3 \\pi^{2} a + b^{3} - 3 \\pi b^{2} + 3 \\pi^{2} b - \\pi^{3}",
        }
        return command, params, solution
