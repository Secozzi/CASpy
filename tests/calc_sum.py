...
class CalcSumTester(BaseTester):
    ...
    def test_calc_sum(self):
        command = "calc_sum"
        params = ['k**2', 'k', '1', 'm', 1, False, False, False, 10]
        solution = {'sum': [' 3    2    \nm    m    m\n-- + -- + -\n3    2    6', 'm*(0.3333333333*m**2 + 0.5*m + 0.1666666667)'], 'latex': '\\frac{m^{3}}{3} + \\frac{m^{2}}{2} + \\frac{m}{6}'}
        return command, params, solution
    ...
    def test_calc_sum_latex(self):
        ...
        solution = {'sum': ['\\frac{m^{3}}{3} + \\frac{m^{2}}{2} + \\frac{m}{6}', 'm*(0.3333333333*m**2 + 0.5*m + 0.1666666667)'], 'latex': '\\frac{m^{3}}{3} + \\frac{m^{2}}{2} + \\frac{m}{6}'}
        return command, params, solution
    ...
    def test_calc_sum_normal(self):
        ...
        solution = {'sum': ['m**3/3 + m**2/2 + m/6', 'm*(0.3333333333*m**2 + 0.5*m + 0.1666666667)'], 'latex': '\\frac{m^{3}}{3} + \\frac{m^{2}}{2} + \\frac{m}{6}'}
        return command, params, solution
    ...
    def test_calc_sum_accuracy(self):
        ...
        solution = {'sum': [' pi           pi                     \n --    /  ___\\                       \n 2     |\\/ 2 |    2           /pi   \\\n2  *pi*|-----|  *e *lowergamma|--, 2|\n       \\  2  /                \\2    /\n-------------------------------------\n                  /    pi\\           \n           2*Gamma|1 + --|           \n                  \\    2 /           ', '5.310652941213842681726704'], 'latex': '\\frac{2^{\\frac{\\pi}{2}} \\pi \\left(\\frac{\\sqrt{2}}{2}\\right)^{\\pi} e^{2} \\gamma\\left(\\frac{\\pi}{2}, 2\\right)}{2 \\Gamma\\left(1 + \\frac{\\pi}{2}\\right)}'}
        return command, params, solution
    ...
    def test_calc_sum_scientific_notation(self):
        ...
        solution = {'sum': ['  pi           pi                       \n  --    /  ___\\                         \n  2     |\\/ 5 |    20           /pi    \\\n20  *pi*|-----|  *e  *lowergamma|--, 20|\n        \\  10 /                 \\2     /\n----------------------------------------\n                   /    pi\\             \n            2*Gamma|1 + --|             \n                   \\    2 /             ', '4.851651890280590966754774*10**8'], 'latex': '\\frac{20^{\\frac{\\pi}{2}} \\pi \\left(\\frac{\\sqrt{5}}{10}\\right)^{\\pi} e^{20} \\gamma\\left(\\frac{\\pi}{2}, 20\\right)}{2 \\Gamma\\left(1 + \\frac{\\pi}{2}\\right)}'}
        return command, params, solution
