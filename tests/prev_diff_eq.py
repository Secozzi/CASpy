...
class PrevDiffEqTester(BaseTester):
    ...
    def test_prev_diff_eq(self):
        ...
        solution = {
            "eq": [
                "d           1  \n--(f(x)) = ----\ndx         f(x)\nClassification: ('separable', '1st_exact', 'Bernoulli', '1st_power_series', 'lie_group', 'separable_Integral', '1st_exact_Integral', 'Bernoulli_Integral')",
                0,
            ],
            "latex": "\\frac{d}{d x} f{\\left(x \\right)} = \\frac{1}{f{\\left(x \\right)}}",
        }
        return command, params, solution
    ...
    def test_prev_diff_eq_latex(self):
        ...
        solution = {
            "eq": [
                "\\frac{d}{d x} f{\\left(x \\right)} = \\frac{1}{f{\\left(x \\right)}}\nClassification: ('separable', '1st_exact', 'Bernoulli', '1st_power_series', 'lie_group', 'separable_Integral', '1st_exact_Integral', 'Bernoulli_Integral')",
                0,
            ],
            "latex": "\\frac{d}{d x} f{\\left(x \\right)} = \\frac{1}{f{\\left(x \\right)}}",
        }
    ...
    def test_prev_diff_eq_func(self):
        ...
        solution = {
            ...
            "latex": "\\frac{d}{d x} \\operatorname{ok}{\\left(x \\right)} = \\frac{1}{\\operatorname{ok}{\\left(x \\right)}}",
        }
        return command, params, solution
    ...
    def test_prev_diff_eq_hint(self):
        ...
        solution = {
            "eq": [
                "                           2             3            \n            d             d             d           -x\n-x - f(x) + --(f(x)) + 5*---(f(x)) + 3*---(f(x)) = e  \n            dx             2             3            \n                         dx            dx             \nClassification: ('nth_linear_constant_coeff_undetermined_coefficients', 'nth_linear_constant_coeff_variation_of_parameters', 'nth_linear_constant_coeff_variation_of_parameters_Integral')",
                0,
            ],
            "latex": "- x - f{\\left(x \\right)} + \\frac{d}{d x} f{\\left(x \\right)} + 5 \\frac{d^{2}}{d x^{2}} f{\\left(x \\right)} + 3 \\frac{d^{3}}{d x^{3}} f{\\left(x \\right)} = e^{- x}",
        }
        return command, params, solution
